<?php
  ...
  * Template Library. Organises multiple views as sections, provides each one with data, and links them together to
  * create a page.
  *
  * @category   Eventing
  * @package    Libraries
 ...
 */
     ...
     * Template Class
     *
     * A simple library for Eventing, building over views to create links to load multiple view with one call.
     */
    class E_Template
    {
        private $links = array(), $sections = array(), $folder = '', $prefix = '', $_last_created = '', $E;
         ...
         * View Path
         *
         * Takes a view and prepends the folder and suffix to it to create the path for CI to load.
         *
         * @access private
         * @param  string $view
         * @return string
         ...
         * Set Folder
         *
         * Sets the sub-directory in which to look for views. Use to split your views into themes.
         * Returns true on success, and false on failure (eg. the folder you specify does not exist).
         *
         * @param string $folder
         * @return boolean
         */
         ...
         * Set Prefix
         *
         * Set the prefix in which to prepend to view paths. Use to split your views into themes.
         * Always returns true.
         *
         * @param  string $prefix
         * @return boolean
        ...
        public function create($views)
        {
            ...
            {
                // If the section already exists, there is no point creating a new one; you'd lose all your data!
                if($this->_section_exists($view))
                {
                    continue;
                }
                // Shortcut for those lazy people, if no array key is given, use the view as the name.
