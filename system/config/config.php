<?php
     ...
     * @version    v0.4
     * @link       http://eventing.zafr.net/source/system/config/config.php
     * @since      v0.1
     */
    ...
    $config = array(
        ...
        'db_host' => 'localhost',
        'db_user' => 'root',
        'db_pass' => 'eventingiscoollike',
        'db_name' => 'eventing',

        # URI Class Settings:
        # Don't bother including a foward slash ('/'):
        'url_default_suffix' => 'htm',
        ...
        'xss_allowed_html' => array('strong', 'b', 'em', 'i', 'h2', 'h3', 'h4', 'p', 'span', 'img', 'code', 'blockquote', 'q', 'hr'),
        ...
        // To enable usage of Zend Libraries within the framework, set this to where the Zend Library folder is located.
        // For example, if the Zend Loader class is located at "/home/username/public_html/Zend/Loader.php", set this to
        // "/home/username/public_html". This does not need to be absolute, just set relative to the $main_file.
        // By default, this is set to the SYS path.
