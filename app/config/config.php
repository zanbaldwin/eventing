 ...
 * Eventing Framework
 *
 * The main configuration file. These are the framework settings for the particular application. Unlike the Registry
 * module, where the settings can be changed, these are hard-coded and set for the entire duration of the application's
 * run-time.
 *
 * @category   Eventing
 * @package    Application
