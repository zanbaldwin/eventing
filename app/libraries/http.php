 ...
 * HTTP Library
 *
 * Make an HTTP connection, and read the response. Think of it as AJAX for the server :)
 *
 * @category	Eventing
 * @package		Libraries
 * @subpackage	HTTP
	...
	class E_http_request {
		...
		private function _fetch() {
			...
			if(substr($this->response_headers[0], 0, 7) == 'HTTP/1.') {
				...
				// Get rid of the raw header, it is of no use to us. Well, unless you want to extend this library to check
				// which 1.x protocol it used... Let's not go there just yet...
