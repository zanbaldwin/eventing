    ...
    <div class="container">
      ...
      <section>
        <p>
          ...
          the framework boasts features such as modules, namespaces,
          <?php echo a('example.aspx', 'multiple URL suffixes'); ?>, a moderately
          advanced theme templating system, etc.
        </p>
        <p>
          The Eventing Framework, at this moment in time, is a fun side-project
          and is not recommended for production use - unfortunately, documentation is also currently lacking (this will be rectified by the time we get round to releasing a public version.<br />
          You can grab a copy of the source
          <?php echo a('~eventingsource', 'on GitHub'); ?>, or follow
          development progress <?php echo a('~eventingtwitter', 'on Twitter'); ?>.
        </p>
      </section>
      <section>
        <p>
          The page you are looking at is being generated dynamically. If you
          would like to edit this page's controller and view, you'll find them
      ...
      <p style="font-size:80%;">
        ...
        This page was rendered in {elapsed_time} seconds and used
